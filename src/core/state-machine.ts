...
const RUN_ALLOWED: Record<RunState, RunState[]> = {
  ...
  DISPATCHING: ["INTEGRATING", "REPLANNING", "ABORTED_BUDGET", "ABORTED_POLICY", "ABORTED_MANUAL", "COMPLETED"],
  ...
  REPLANNING: ["PLAN_FROZEN", "DISPATCHING", "ABORTED_POLICY", "ABORTED_BUDGET"],
